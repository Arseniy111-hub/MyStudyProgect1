...
sealed interface NoteIntent {
    ...
    data class SetCategoryName(val categoryName: String): NoteIntent
    data class DeleteCategory(val category: NoteCategory): NoteIntent
    object SaveCategory: NoteIntent
    object DisplayCategoryScreen: NoteIntent
    object HideCategoryScreen: NoteIntent
    data class SetCurrentCategoryId(val currentCategoryId: Int): NoteIntent
    object SetCategoryIsPinned: NoteIntent
}